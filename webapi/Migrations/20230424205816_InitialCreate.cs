        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Networks_NetworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Application_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Application_JobOffers_JobOfferId",
                        column: x => x.JobOfferId,
                        principalTable: "JobOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteJobOffer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteJobOffer_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteJobOffer_JobOffers_JobOfferId",
                        column: x => x.JobOfferId,
                        principalTable: "JobOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Interviews_RecruiterRole", "EXISTS(SELECT 1 FROM Accounts a WHERE a.Id = RecruiterId AND a.Role = 'Recruiter')");
                    table.ForeignKey(
                        name: "FK_Interviews_Accounts_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Interviews_JobOffers_JobOfferId",
                        column: x => x.JobOfferId,
                        principalTable: "JobOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notification_Accounts_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalEvents_Accounts_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedJobSearch_Accounts_UserId",
                        column: x => x.UserId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserConnection_Accounts_RequestedId",
                        column: x => x.RequestedId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserConnection_Accounts_RequestorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndorsedId = table.Column<int>(type: "int", nullable: false),
                    EndorsementDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SkillId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEndorsement", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserEndorsement_Accounts_EndorsedId",
                        column: x => x.EndorsedId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserEndorsement_Accounts_EndorserId",
                        column: x => x.EndorserId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserEndorsement_Accounts_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroup_Accounts_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInterest_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLanguage_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSkill_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEventParticipation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserEventParticipation_Accounts_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserEventParticipation_ProfessionalEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "ProfessionalEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroupMember_Accounts_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGroupMember_UserGroup_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteJobOffer_AccountId",
                table: "FavoriteJobOffer",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteJobOffer_JobOfferId",
                table: "FavoriteJobOffer",
                column: "JobOfferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalEvents_OrganizerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConnection_RequestedId",
                table: "UserConnection",
                column: "RequestedId");

            migrationBuilder.CreateIndex(
                name: "IX_UserConnection_RequestorId",
                table: "UserConnection",
                column: "RequestorId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEndorsement_EndorsedId",
                table: "UserEndorsement",
                column: "EndorsedId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEndorsement_EndorserId",
                table: "UserEndorsement",
                column: "EndorserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEndorsement_SkillId",
                table: "UserEndorsement",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEventParticipation_EventId",
                table: "UserEventParticipation",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_UserEventParticipation_ParticipantId",
                table: "UserEventParticipation",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroup_AdminId",
                table: "UserGroup",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupMember_GroupId",
                table: "UserGroupMember",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupMember_MemberId",
                table: "UserGroupMember",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInterest_AccountId",
                table: "UserInterest",
                column: "AccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLanguage_AccountId",
                table: "UserLanguage",
                column: "AccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSkill_AccountId",
                table: "UserSkill",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSkill_SkillsId",
                table: "UserSkill",
                column: "SkillsId");
        }
